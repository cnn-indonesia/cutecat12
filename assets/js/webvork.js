(function () {
    ...
    var wvParams = {
        ...
        get: function (name) {
            ...
            return (name === null) ? undefined : decodeURIComponent(name[ 1 ]);
        },
    ...
    var wvCookie = {
        ...
        setParamsToCookie: function () {
            var paramsArr = [ 'ym', 'fb', 'fb_sot', 'fb_sol', 'fb_sos', 'utm_source', 'utm_medium', 'utm_campaign', 'utm_content', 'utm_term' ];
    ...
    var wvMetric = {
        ...
        add: function (type, counterID) {
            switch (type) {
                ...
                case 'FB':
                    if (counterID !== null) {
                        var scriptFB;
                        var track = (this.pageType === 'success') ? 'fbq(\'track\', \'Lead\'); fbq(\'track\', \'AddToCart\');' : 'fbq(\'track\', \'PageView\');';
        ...
        set: function (ym, ga, fb, pageType) {
            this.pageType = pageType;
            if (ym) {
                return this.add('YM', ym);
            }
            if (ga) {
                return this.add('GA', ga);
            }
        ...
        init: function () {
            ...
            if (wvParams.pageType !== 'landing') {
                ...
                if (wvParams.pageType === 'success') {
                    ...
                    wvParams.YmCounter = '52506784';
                    wvParams.GaCounter = 'UA-133739380-33';
    ...
    wvMetric.set(wvPageData.ym, wvPageData.ga, wvPageData.fb, wvParams.pageType);
